...
import { searchAuthorsInput, runSearchAuthors } from "../src/server/tools/searchAuthorsV2.js";
import { searchBooksInput, runSearchBooks } from "../src/server/tools/searchBooksV2.js";
import { searchPagesInput, runSearchPages } from "../src/server/tools/searchPagesV2.js";
...
async function main(): Promise<number> {
    ...
    console.log("shamela-mcp v1.0 smoke test (20 tools)");
...
main()
    ...
    .catch((err) => {
        console.error("smoke-v1 crashed:", err);
        process.exit(1);
    });
